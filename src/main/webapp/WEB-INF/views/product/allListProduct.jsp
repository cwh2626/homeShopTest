      ...
      <div class="container">
        <div class="row">
          ...
          <c:forEach var="list" items="${productList}">
	          <div class="col-md-4">
	            <div class="card-box-a card-shadow" style="width: 360px;height: 360px;"> 
	              <div  class="img-box-a"> 
	                <img src="../resources/member/${list.email}/photo/${list.productFirstPhotoName}" alt="" class="img-a img-fluid" style="width: 360px;height: 360px;"> 
	              </div> 
	              <div class="card-overlay">
	                <div class="card-overlay-a-content">
	                  <div class="card-header-a">
	                    <h4 class="card-title-a">
	                      <a href="#"><c:out value="${list.productName}"></c:out></a>
	                    </h4>  
	                  </div>
